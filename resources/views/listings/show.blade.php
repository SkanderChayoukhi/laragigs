...
<form method="POST" action="/listings/{{$listing->id}}"> the delete require a form beacuse we're not navigating like edit but instead we're submitting a delete request --}}
{{-- @csrf    --}}
